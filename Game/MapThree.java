...
public class MapThree extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToMainMenu = new Intent(MapThree.this, MainMenu.class);
        ...
        i2.setX(20+(horInc*3)); i2.setY(20);

        i3.setX(20);            i3.setY(20+(vertInc*4));
    ...
    public void checkButtons(){
        ...
        float[][] pos = new float[][] {
                ...
                {0, 40+horInc+vertInc, 0,0, 0},  //Line 1
                {0, 40+horInc+vertInc*2, 40+horInc*2+vertInc*2, 40+horInc*3+vertInc*2, 40+horInc*4+vertInc*2},    //Line 2
                {0, 0, 20+horInc*2+vertInc*3+20,0,40+horInc*4+vertInc*3},//Line 3
                {40+vertInc*4, 40+horInc+vertInc*4, 40+horInc*2+vertInc*4, 40+horInc*3+vertInc*4, 40+horInc*4+vertInc*4},    //Line 4
                {0, 40+horInc+vertInc*5, 40+horInc*2+vertInc*5, 40+horInc*3+vertInc*5, 0},    //Line 5
                {0, 40+horInc+vertInc*6, 40+horInc*2+vertInc*6, 40+horInc*3+vertInc*6, 0},// Line 6
                {0, 0, 20+horInc*3+vertInc*7+20,0, 0},    //Line 7
                {0, 0, 0, 0, 0}, //Line 8
        };
//Singles
        if(addedPos==pos[0][0] || addedPos==pos[6][1] || addedPos==pos[4][0] || addedPos==pos[7][1]) {
            right.setVisibility(View.VISIBLE);

            left.setVisibility(View.INVISIBLE); down.setVisibility(View.INVISIBLE); up.setVisibility(View.INVISIBLE);
        }

        else if(addedPos==pos[0][3] || addedPos==pos[4][4] || addedPos==pos[5][3] || addedPos==pos[6][3] || addedPos==pos[7][3]) {
            left.setVisibility(View.VISIBLE);

            down.setVisibility(View.INVISIBLE); up.setVisibility(View.INVISIBLE); right.setVisibility(View.INVISIBLE);
        }

        else if(addedPos==pos[3][4]) {
            up.setVisibility(View.VISIBLE);

            down.setVisibility(View.INVISIBLE); right.setVisibility(View.INVISIBLE); left.setVisibility(View.INVISIBLE);
        }


//Doubles
        else if(addedPos==pos[1][1] || addedPos==pos[3][2]) {
            down.setVisibility(View.VISIBLE); up.setVisibility(View.VISIBLE);

            right.setVisibility(View.INVISIBLE); left.setVisibility(View.INVISIBLE);
        }

        else if(addedPos==pos[0][2] || addedPos==pos[2][3]|| addedPos==pos[4][3]){
            right.setVisibility(View.VISIBLE); left.setVisibility(View.VISIBLE);

            down.setVisibility(View.INVISIBLE); up.setVisibility(View.INVISIBLE);
        }

        else if(addedPos==pos[2][4]){
            down.setVisibility(View.VISIBLE); left.setVisibility(View.VISIBLE);

            right.setVisibility(View.INVISIBLE); up.setVisibility(View.INVISIBLE);
        }

        else if(addedPos==pos[5][1] || addedPos==pos[2][1]){
            up.setVisibility(View.VISIBLE); right.setVisibility(View.VISIBLE);

            left.setVisibility(View.INVISIBLE); down.setVisibility(View.INVISIBLE);
        }

        else if(addedPos==pos[2][4]) {
            left.setVisibility(View.VISIBLE); down.setVisibility(View.VISIBLE);

            up.setVisibility(View.INVISIBLE); right.setVisibility(View.INVISIBLE);
        }
//Triples
        else if(addedPos==pos[4][1] || addedPos==pos[0][1] || addedPos==pos[2][2] || addedPos==pos[5][2]) {
            right.setVisibility(View.VISIBLE); left.setVisibility(View.VISIBLE); down.setVisibility(View.VISIBLE);

            up.setVisibility(View.INVISIBLE);
        }

        else if(addedPos==pos[4][2]) {
            right.setVisibility(View.VISIBLE); left.setVisibility(View.VISIBLE); up.setVisibility(View.VISIBLE);

            down.setVisibility(View.INVISIBLE);
        }
//Quadruples
        else if(addedPos==pos[6][2]) {
            down.setVisibility(View.VISIBLE); up.setVisibility(View.VISIBLE); left.setVisibility(View.VISIBLE); right.setVisibility(View.VISIBLE);
        }
    ...
    public void enemyMove() {
        ...
        int[] guard2 = {1,1,1,1,0,0,0,0};
        int[] guard1 = {0,0,3,3,1,1,1,0,0,0,2,2,1,1};
        ...
        j++;
        if(i == 8) i=0;
        if(j == 14) j=0;//reset movement array
    }//End of enemyMove method
} //End of MapThree.class